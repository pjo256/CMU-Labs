...
def main():
    ...
    trans32_score = computeMissScore(miss32, 550, 700, maxscore['trans32']) * int(result32[0])
    trans64_score = computeMissScore(miss64, 2700, 3000, maxscore['trans64']) * int(result64[0])
    trans61_score = computeMissScore(miss61, 2800, 3200, maxscore['trans61']) * int(result61[0])
